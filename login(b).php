    ...
    <div class="container">
        ...
        <form action="log.php" method="post" class="login-email">
            ...
            <div class="input-group">
                ...
                <input type="email" palceholder="Email" name="email" required>
            </div>
            ...
            <p class="Login-register-text">Don't have an account? <a href="sign-up(b).php">Register Here</a>.</p>
        </form>
    </div>
    <footer>
