...
<header>
        ...
        <ul>
            ...
            <li><a href="sign-up(b).php" class="active">Register Your Bus</a></li>
...
<div class="container">
        <form action="connect.php" method="POST" class="login_email">
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">Register your Bus</p>
            <div class="input-group">
           
                <select palceholder="Bus Ownership Type" name="ownership"  required>
            ...
            <div class="input-group">
                <input type="text" placeholder="Bus Registation Number" name="regnum" required>
            </div>
            
            <div class="input-group">
            <input type="text" placeholder="Seat Count" name="seatcount" required>
            <select  name="bustype" required>
                    <option selected disabled></option>
                    <option value="normal">Normal</option>
                    <option value="semi">Semi-Luxury</option>
                    <option value="intercity">Intercity</option>
                    <option value="Privat">High-Way Bus</option>
                </select>
            </div>
            
            <div class="input-group">
                <input type="text" placeholder="Root Permit Number" name="root" required>
            </div>
            ...
            <p class="login-register-text">Have an Account? <a href="login(b).php">Login Here</a>.</p>
